    ...
    d_hearMessage(-1, 0, "")
{
  ...
  d_objectTypesMap[Types::BALL] = iVisionBall;
  d_objectTypesMap[Types::PLAYER1] = iVisionPlayer1;
  d_objectTypesMap[Types::PLAYER2] = iVisionPlayer2;
  d_objectTypesMap[Types::PLAYER3] = iVisionPlayer3;
  d_objectTypesMap[Types::PLAYER4] = iVisionPlayer4;
  d_objectTypesMap[Types::PLAYER5] = iVisionPlayer5;
  d_objectTypesMap[Types::PLAYER6] = iVisionPlayer6;
  d_objectTypesMap[Types::PLAYER7] = iVisionPlayer7;
  d_objectTypesMap[Types::PLAYER8] = iVisionPlayer8;
  d_objectTypesMap[Types::PLAYER9] = iVisionPlayer9;
  d_objectTypesMap[Types::PLAYER10] = iVisionPlayer10;
  d_objectTypesMap[Types::PLAYER11] = iVisionPlayer11;
  d_objectTypesMap[Types::OPPONENT1] = iVisionOpponent1;
  d_objectTypesMap[Types::OPPONENT2] = iVisionOpponent2;
  d_objectTypesMap[Types::OPPONENT3] = iVisionOpponent3;
  d_objectTypesMap[Types::OPPONENT4] = iVisionOpponent4;
  d_objectTypesMap[Types::OPPONENT5] = iVisionOpponent5;
  d_objectTypesMap[Types::OPPONENT6] = iVisionOpponent6;
  d_objectTypesMap[Types::OPPONENT7] = iVisionOpponent7;
  d_objectTypesMap[Types::OPPONENT8] = iVisionOpponent8;
  d_objectTypesMap[Types::OPPONENT9] = iVisionOpponent9;
  d_objectTypesMap[Types::OPPONENT10] = iVisionOpponent10;
  d_objectTypesMap[Types::OPPONENT11] = iVisionOpponent11;
  d_objectTypesMap[Types::FLAG1L] = iVisionFlag1L;
  d_objectTypesMap[Types::FLAG2L] = iVisionFlag2L;
  d_objectTypesMap[Types::FLAG1R] = iVisionFlag1R;
  d_objectTypesMap[Types::FLAG2R] = iVisionFlag2R;
  d_objectTypesMap[Types::GOAL1L] = iVisionGoal1L;
  d_objectTypesMap[Types::GOAL2L] = iVisionGoal2L;
  d_objectTypesMap[Types::GOAL1R] = iVisionGoal1R;
  d_objectTypesMap[Types::GOAL2R] = iVisionGoal2R;
