...
namespace bats
{
  ...
  template<typename B>
  rf<Behavior> createBehavior(std::string const& id, std::string const& playerClass)
  {
    return new B(id, playerClass);
  }
  ...
  class BehaviorFactory
  {
    ...
    public:
      ...
      rf<Behavior> createBehavior(std::string const& key, std::string const& id, std::string const& playerClass);
